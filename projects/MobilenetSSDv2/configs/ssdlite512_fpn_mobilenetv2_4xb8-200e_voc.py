...
custom_imports = dict(
    imports=['projects.MobilenetSSDv2.models',] 
)
...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            min_sizes=[77, 160, 240, 323, 405, 486],
            max_sizes=[160, 240, 323, 405, 486, 512]),
        bbox_coder=dict(
...
# data_root = '/workspace/datasets/VOCdevkit/'
data_root = '/home/rvl224/2TB_disk/datasets/VOCdevkit'
...
optim_wrapper = dict(
    ...
    optimizer=dict(type='SGD', lr=0.001, momentum=0.9, weight_decay=4.0e-5))
...
work_dir = './work_dirs/MobilenetvSSDv2/ssdlite512_fpn_mobilenetv2_4xb8-200e_voc'
